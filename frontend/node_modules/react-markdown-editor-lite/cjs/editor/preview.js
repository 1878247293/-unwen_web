...
class Preview extends external_react_namespaceObject.Component {
    el;
    constructor(props){
        super(props);
        this.el = /*#__PURE__*/ external_react_namespaceObject.createRef();
    }
    getElement() {
...
class HtmlRender extends Preview {
    ...
    render() {
        return 'string' == typeof this.props.html ? /*#__PURE__*/ external_react_namespaceObject.createElement('div', {
            ref: this.el,
