...
class Image extends external_Plugin_js_namespaceObject.PluginComponent {
    ...
    constructor(props){
        super(props);
        this.inputFile = /*#__PURE__*/ external_react_namespaceObject.createRef();
    ...
    render() {
        ...
        return isCustom ? /*#__PURE__*/ external_react_namespaceObject.createElement("span", {
            className: "button button-type-image",
            title: external_i18n_index_js_default().get('btnImage'),
            onClick: this.handleCustomImageUpload
        }, /*#__PURE__*/ external_react_namespaceObject.createElement(index_js_default(), {
            type: "image"
            ...
            type: "image"
        }), /*#__PURE__*/ external_react_namespaceObject.createElement(external_inputFile_js_default(), {
