...
class TableList extends external_react_namespaceObject.Component {
    config = {
        padding: 3,
        width: 20,
        height: 20
    ...
    render() {
        ...
        }, this.state.list.map((row, i)=>row.map((col, j)=>/*#__PURE__*/ external_react_namespaceObject.createElement("li", {
